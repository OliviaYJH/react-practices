    ...
    return (
        <>
            ...
            <Modal
                ...
                <h1>modal01</h1>
                <button
                    onClick={() => setModal01IsOpen(false)}>
                    Close
                </button>
            </Modal>
            ...
            <button
                onClick={() => setModal02IsOpen(true)}
                >modal02</button>
            <br/><br/>

            <Modal
                isOpen={modal02IsOpen}
                onRequestClose={() => console.log("!!!")} // 밖 부분을 클릭한 경우 
                contentLabel="modal02 example">
                <h1>modal02</h1>
                <button
                    onClick={() => setModal02IsOpen(false)}>
                    Close
                </button>
            </Modal>
            ...
            <button
                onClick={() => setModal03IsOpen(true)}>modal03</button>
            <br/><br/>
            <Modal
                isOpen={modal03IsOpen}
                onRequestClose={() => setModal03IsOpen(false)}
                shouldCloseOnOverlayClick={true} // true: 밖 부분 클릭하면 모달창 없어짐 
